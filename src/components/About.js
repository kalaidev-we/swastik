      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="absolute -inset-4 border border-accent-gold/20 rounded-md -z-10 translate-x-2 translate-y-2 pointer-events-none" />
            
            {/* The Image Container */}
            <div className="relative aspect-[4/5] w-full rounded-md overflow-hidden bg-bg-card border border-white/10 group shadow-2xl">
              <div
              ...
              />
              {/* Overlay shading */}
              <div className="absolute inset-0 bg-gradient-to-t from-bg-main/90 via-transparent to-transparent opacity-60" />
            </div>
            ...
            <motion.div
              ...
              className="absolute -right-4 -bottom-4 bg-bg-card/90 backdrop-blur-md border border-accent-gold/30 p-6 rounded-sm shadow-xl max-w-[200px]"
            >
          ...
          >
            ...
            <div className="text-text-muted space-y-4 font-light text-base md:text-lg leading-relaxed mb-8">
              <p>
